...
<div class="main-footer bg-black clearfix">
    <div class="container clearfix">
        ...
        <div class="col-md-3">
            ...
            <ul class="footer-nav">
                <li><a href="hero-static.html" title="Static hero sections"><span>Home</span></a></li>
                <li><a href="hero-alignments.html" title="Hero alignments"><span>Exam Policy</span></a></li>
                <li><a href="hero-overlays.html" title="Hero overlays"><span>Refund Policy</span></a></li>
                <li><a href="hero-overlays.html" title="Hero overlays"><span>Extension Policy</span></a></li>
                <li><a href="hero-overlays.html" title="Hero overlays"><span>FAQ</span></a></li>
                <li><a href="hero-overlays.html" title="Hero overlays"><span>Contact</span></a></li>
            </ul>
        </div>
        <div class="col-md-3">
            ...
            <ul class="footer-contact">
              <li>
                ...
                <li>
                    ...
                    L5/175 Flinders Lane, Melbourne 3000
                </li>
                <li>
                ...
                <li>
                    ...
                    <a href="#" title="">amebexams.edu.au</a>
                </li>
                <li>
                    <i class="glyph-icon icon-envelope-o"></i>
                    <a href="#" title="">online@ameb.edu.au</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="footer-pane">
        <div class="container clearfix">
            <div class="logo">&copy; 2017 AMEB Federal. All Rights Reserved.</div>
            <div class="footer-nav-bottom">
                <a href="#" title="Layout">Buy Books</a>
                <a href="#" title="Layout">FAQ</a>
                <a href="#" title="Elements">About</a>
