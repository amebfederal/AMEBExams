    ...
    <div class="col-md-12">
            ...
            <div class="panel-content image-box">
                ...
                <div class="image-content font-white">
                    ...
                    <div class="meta-box ">
                        ...
                        <h4 class="meta-subheading">smohammad@ameb.edu.au</h4>
                ...
                <img src="{{ asset('resources/assets/image-resources/blurred-bg/blurred-bg-13.jpg')}}" alt="">
        ...
        <div class="panel-box">
            ...
            <div class="panel-content image-box">
                ...
                <img src="{{ asset('resources/assets/image-resources/blurred-bg/blurred-bg-12.jpg')}}" alt="">
