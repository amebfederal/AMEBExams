                ...
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="example-box-wrapper">
                            <h2>Authorise form is required before starting the exam for an individual exam and group exam needs to be authorised by the teacher from their portal.</h2>

                            By starting this exam, you will be now redirected to our examination software. If any issues comes in between please try to take any screenshot or any other issues if persists.


                            <div class="col-md-5 pull-right text-right">
                                <a href="#" class="btn btn-success">Start Exam</a>
                            </div>
