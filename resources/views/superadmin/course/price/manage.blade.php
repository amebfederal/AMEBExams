...
@section('content')
    ...
    <div class="panel">
        <div class="panel-body">
            <h3 class="title-hero">
                Set Course price for States
            </h3>

            <div class="example-box-wrapper">
                <form class="form-horizontal bordered-row" action="{{ route('course.save-price', $course->id) }}"
                        method="post">
                    {!! csrf_field() !!}
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Course Title <span class="text-danger">*</span> </label>

                        <div class="col-sm-6">
                            <input type="text" name="" id="" class="form-control" disabled="disabled"
                                   placeholder="Exam name here" value="{{ $course->title }}">
                        </div>
                    </div>
                    <div class="form-group">
