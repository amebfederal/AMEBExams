...
<div class="center-vertical">
    <div class="center-content row">
        ...
        <div class="col-md-8 col-lg-6 clearfix center-margin">
            <div class="row">
                <div class="col-md-5">
                    <h3 class="text-transform-upr font-size-17">AMEB Admin Portal</h3>
                    <p class="font-gray">Login to your account</p>
                    <div class="divider"></div>
                    <ul class="reset-ul">
                        <li class="pad10A font-size-12">
                            <i class="glyph-icon icon-user mrg10R font-green"></i>
                            Administrator
                        </li>
                        <li class="pad10A font-size-12">
                            <i class="glyph-icon icon-user mrg10R font-red"></i>
                            Markers
                        </li>
                        <li class="pad10A font-size-12">
                            <i class="glyph-icon icon-user mrg10R font-orange"></i>
                            States
                        </li>
                        <li class="pad10A font-size-12">
                            <i class="glyph-icon icon-user mrg10R font-orange"></i>
...
<script type="text/javascript" src="{{ asset('resources/assets/widgets/theme-switcher/themeswitcher.js')}}"></script>
